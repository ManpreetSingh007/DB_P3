...
public class TaskSpecific extends ListItem {
	...
	static ComboBox <String> theRole = new ComboBox <String>(FXCollections.observableArrayList());
	...
	static 
	ComboBox <String> theUsedArtifact = new ComboBox <String>(FXCollections.observableArrayList());
	...
	static ComboBox <String> theProducedArtifact = new ComboBox <String>(FXCollections.observableArrayList());
