...
* 
* @author Lynn Robert Carter, Vaibhav M.
* 
* @version 1.01	2019-06-05 Baseline
* @version 1.02	2019-09-11 Database connectivity to store data into the mysql tables
* 
*/
public class ListItem {
	...
	**********************************************************************************************/
	...
	public ListItem(Group g, int x, int y, TabNames t) {
		...
		btnAddBottom.setOnAction((event) -> { 
			String a= theNameField.getText();
			String b= theDescriptionArea.getText();
		
		switch (t) {
		
		case LIFECYCLES:		
			insertDBlifecycle(a,b);
		break;
		...
		case CONDITIONS:
			insertDBconditions(a,b);
			break;
			
		case ARTIFACTS:
			insertDBartifacts(a,b);
			break;
		...
		case TASKS:	
			String c= new String(TaskSpecific.theProducedArtifact.getValue());
			String d= new String(TaskSpecific.theUsedArtifact.getValue());
			String e= new String(TaskSpecific.theRole.getValue());
			insertDBtasks(a,b,c,d,e);
			break;
		default:
	...
	**********************************************************************************************/
	...
	public class ListItemEntry {
	 ...
	 public void insertDBlifecycle(String f1, String f2){
	       if(f1.isEmpty()|| f2.isEmpty()){
	             System.out.println("The field cannot be null!");
	        }
	      else{
	        	try {
	             Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/dbcsp1","root","toor");
	             ...
	             preparedStatement.executeUpdate();
	        		...
	        		Alert err = new Alert(AlertType.ERROR); 
	        		 err.setContentText("Already in DataBase! It will not be saved again in Database");
	        		 err.show();
	        	
	        	}
	        	}
	     }
	 public void insertDBroles(String f1, String f2){
	       if(f1.isEmpty()|| f2.isEmpty()){
	             System.out.println("The field cannot be null!");
	        }
	      else{
	        	try {
	             Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/dbcsp1","root","toor");
	             String sql = "INSERT INTO roles (roles_Name, roles_Description)" +
	            	        "VALUES (?, ?)";
	             PreparedStatement preparedStatement = connection.prepareStatement(sql);
	             preparedStatement.setString(1, f1);
	             preparedStatement.setString(2, f2);
	 ...
	 public void insertDBartifacts(String f1, String f2){
	       if(f1.isEmpty()|| f2.isEmpty()){
	             System.out.println("The field cannot be null!");
	        }
	      else{
	        	try {
	             Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/dbcsp1","root","toor");
	             String sql = "INSERT INTO artifacts (artifacts_Name, artifacts_Description)" +
	            	        "VALUES (?, ?)";
	             PreparedStatement preparedStatement = connection.prepareStatement(sql);
	             preparedStatement.setString(1, f1);
	             preparedStatement.setString(2, f2);
	 ...
	 public void insertDBsteps(String f1, String f2){
	       if(f1.isEmpty()|| f2.isEmpty()){
	             System.out.println("The field cannot be null!");
	        }
	      else{
	        	try {
	             Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/dbcsp1","root","toor");
	             String sql = "INSERT INTO steps (steps_Name, steps_Description)" +
	            	        "VALUES (?, ?)";
	             PreparedStatement preparedStatement = connection.prepareStatement(sql);
	             preparedStatement.setString(1, f1);
	             preparedStatement.setString(2, f2);
	 ...
	 public void insertDBconditions(String f1, String f2){
	       if(f1.isEmpty()|| f2.isEmpty()){
	             System.out.println("The field cannot be null!");
	        }
	      else{
	        	try {
	             Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/dbcsp1","root","toor");
	             String sql = "INSERT INTO conditions (conditions_Name, conditions_Description)" +
	            	        "VALUES (?, ?)";
	             PreparedStatement preparedStatement = connection.prepareStatement(sql);
	             preparedStatement.setString(1, f1);
	             preparedStatement.setString(2, f2);
	 ...
	 public void insertDBinterruptions(String f1, String f2){
	       if(f1.isEmpty()|| f2.isEmpty()){
	             System.out.println("The field cannot be null!");
	        }
	      else{
	        	try {
	             Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/dbcsp1","root","toor");
	             String sql = "INSERT INTO interruptions (interruptions_Name, interruptions_Description)" +
	            	        "VALUES (?, ?)";
	             PreparedStatement preparedStatement = connection.prepareStatement(sql);
	             preparedStatement.setString(1, f1);
	             preparedStatement.setString(2, f2);
	 ...
	 public void insertDBdefects(String f1, String f2){
	       if(f1.isEmpty()|| f2.isEmpty()){
	             System.out.println("The field cannot be null!");
	        }
	      else{
	        	try {
	             Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/dbcsp1","root","toor");
	             String sql = "INSERT INTO defects (defects_Name, defects_Description)" +
	            	        "VALUES (?, ?)";
	             PreparedStatement preparedStatement = connection.prepareStatement(sql);
	             preparedStatement.setString(1, f1);
	             preparedStatement.setString(2, f2);
	 ...
	 public void insertDBplans(String f1, String f2){
	       if(f1.isEmpty()|| f2.isEmpty()){
	             System.out.println("The field cannot be null!");
	        }
	      else{
	        	try {
	             Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/dbcsp1","root","toor");
	             String sql = "INSERT INTO plans (plans_Name, plans_Description)" +
	            	        "VALUES (?, ?)";
	             PreparedStatement preparedStatement = connection.prepareStatement(sql);
	             preparedStatement.setString(1, f1);
	             preparedStatement.setString(2, f2);
	 ...
	 public void insertDBtasks(String f1, String f2, String f3, String f4, String f5){
	       if(f1.isEmpty()|| f2.isEmpty()){
	             System.out.println("The field cannot be null!");
	        }
	      else{
	        	try {
	             ...
	             String sql = "INSERT INTO tasks (tasks_Name, tasks_Description, produced_artifacts_Name, used_artifacts_Name, roles_Name)" +
	            	        "VALUES (?, ?, ?, ?, ?)";
	             PreparedStatement preparedStatement = connection.prepareStatement(sql);
	             ...
	             preparedStatement.setString(3, f3);
	             
	             preparedStatement.setString(4, f4);
	             
	             preparedStatement.setString(5, f5);
	 ...
	 public void insertDBeffort_categories(String f1, String f2){
	       if(f1.isEmpty()|| f2.isEmpty()){
	             System.out.println("The field cannot be null!");
	        }
	      else{
	        	try {
	             Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/dbcsp1","root","toor");
	             String sql = "INSERT INTO effortcategories(effort_Name, effort_Description)" +
	            	        "VALUES (?, ?)";
	             PreparedStatement preparedStatement = connection.prepareStatement(sql);
	             preparedStatement.setString(1, f1);
	             preparedStatement.setString(2, f2);
